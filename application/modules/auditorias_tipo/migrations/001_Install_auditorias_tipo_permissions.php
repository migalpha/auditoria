...
class Migration_Install_auditorias_tipo_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Auditorias_Tipo.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias_Tipo.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias_Tipo.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias_Tipo.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
