...
class Migration_Install_respuestas_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Respuestas.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Respuestas.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Respuestas.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Respuestas.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
