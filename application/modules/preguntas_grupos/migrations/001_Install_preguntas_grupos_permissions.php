...
class Migration_Install_preguntas_grupos_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Preguntas_Grupos.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Preguntas_Grupos.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Preguntas_Grupos.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Preguntas_Grupos.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
