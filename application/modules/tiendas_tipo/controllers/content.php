...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Tiendas_Tipo.Content.View');
	...
	{
		$this->auth->restrict('Tiendas_Tipo.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_tiendas_tipo())
			{
				...
				redirect(SITE_AREA .'/content/tiendas_tipo');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Tiendas_Tipo.Content.Edit');
		...
		{
			$this->auth->restrict('Tiendas_Tipo.Content.Delete');
