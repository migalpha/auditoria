...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Tiendas_Tipo.Developer.View');
	...
	{
		$this->auth->restrict('Tiendas_Tipo.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_tiendas_tipo())
			{
				...
				redirect(SITE_AREA .'/developer/tiendas_tipo');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Tiendas_Tipo.Developer.Edit');
		...
		{
			$this->auth->restrict('Tiendas_Tipo.Developer.Delete');
