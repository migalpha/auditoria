...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Tiendas_Tipo.Settings.View');
	...
	{
		$this->auth->restrict('Tiendas_Tipo.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_tiendas_tipo())
			{
				...
				redirect(SITE_AREA .'/settings/tiendas_tipo');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Tiendas_Tipo.Settings.Edit');
		...
		{
			$this->auth->restrict('Tiendas_Tipo.Settings.Delete');
