	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/reports/tiendas_tipo', lang('tiendas_tipo_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Tiendas_Tipo.Reports.Delete')) : ?>
				or
