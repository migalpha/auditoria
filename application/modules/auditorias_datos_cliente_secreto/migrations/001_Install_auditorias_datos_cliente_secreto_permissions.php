...
class Migration_Install_auditorias_datos_cliente_secreto_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Auditorias_Datos_Cliente_Secreto.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias_Datos_Cliente_Secreto.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias_Datos_Cliente_Secreto.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias_Datos_Cliente_Secreto.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
