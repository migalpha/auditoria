...
class Migration_Install_tiendas_grupos_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Tiendas_Grupos.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tiendas_Grupos.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tiendas_Grupos.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tiendas_Grupos.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
