...
class Migration_Install_preguntas_tipo_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Preguntas_Tipo.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Preguntas_Tipo.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Preguntas_Tipo.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Preguntas_Tipo.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
