...
class Migration_Install_observaciones_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Observaciones.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Observaciones.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Observaciones.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Observaciones.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
