...
class Migration_Install_tiendas_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Tiendas.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tiendas.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tiendas.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tiendas.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
