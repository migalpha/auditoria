	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<?php // Change the values in this array to populate your dropdown as required
				...
				echo form_dropdown('auditorias_tipo_tienda_id', $tiendas_tipo, set_value('auditorias_tipo_tienda_id', isset($auditorias['tipo_tienda_id']) ? $auditorias['tipo_tienda_id'] : ''), 'Tipo Tienda Id'. lang('bf_form_label_required'));
			?>

			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('auditorias_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
