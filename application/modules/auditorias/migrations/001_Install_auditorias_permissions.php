...
class Migration_Install_auditorias_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Auditorias.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Auditorias.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
